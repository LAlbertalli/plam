# PLAM Design Documentation

Welcome to the Personal Local Agent Manager (PLAM) design documentation.
...
- [Docker & Resource Manager](components/docker_manager.md)
- [Proxy System](components/proxy_system.md)
- [Memory Subsystem](components/memory_subsystem.md)
- [Agent Framework](components/agent_framework.md)
- [Security & Sandboxing](components/security_sandboxing.md)
- [Web UI (Next.js)](components/web_ui.md)
